...
mu =  398600.4415e+9; % [m3/s2] Earth's geocentric gravitational constant
...
fprintf(1,['Kepler Elements for satelliteID %d epoch %s:\n' ...
    ...
    datestr(OE.epoch),OE.a_km, OE.e, deg2rad(OE.i_deg), deg2rad(OE.omega_deg), ...
    deg2rad(OE.Omega_deg), deg2rad(OE.M_deg));
a_m = OE.a_km*1e3;
e = OE.e;
M_deg = OE.M_deg;
