...
// [jmm220615] Per poder referir-se a Matrix dins la declaració
// de membres de la class Vector
class Matrix;
...
class Vector {
 public:
  ...
  // [jmm220615] el default argument dona un error de compilació
  // L'especifico al fondo, a la declaració de fora de la classe
...
// [jmm220615] Afegeixo funcions definides com a friend de la class Matrix
// perquè es puguin cridar des de fora
