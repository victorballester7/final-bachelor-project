...
\begin{tikzpicture}
  ...
  \begin{axis}[
    ...
    \def\filenameA{../../../data/plot/SIRIUS_3_sphHarm.txt}
    \def\filenameB{../../../data/plot/SIRIUS_3_sphHarm_moon.txt}
    \def\filenameC{../../../data/plot/SIRIUS_3_sphHarm_sun_moon.txt}
    \def\filenameD{../../../data/plot/SIRIUS_3_sphHarm_sun_moon_solarRad.txt}
