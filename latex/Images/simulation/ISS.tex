...
\begin{tikzpicture}
  ...
  \begin{axis}[
    ...
    \def\filenameB{../../../data/plot/ISS_sphHarm_atmoDrag.txt}
    ...
    \addplot [fill=sphHarmDrag!15,forget plot] fill between[of=upper and lower];
    \addplot [name path=middle,sphHarmDrag] table[x=time,y=error] {\filenameB};
