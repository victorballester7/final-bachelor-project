...
\begin{tikzpicture}
  ...
  \begin{axis}[
    ...
    \addplot [fill=sphHarmMoon!15,forget plot] fill between[of=upper and lower];
    ...
    \addplot [fill=sphHarmMoonSun!15,forget plot] fill between[of=upper and lower];
    ...
    \addplot [fill=sphHarmMoonSunSolarRad!15,forget plot] fill between[of=upper and lower];
