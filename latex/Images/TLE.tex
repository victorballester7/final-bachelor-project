...
\begin{tikzpicture}
  ...
  \node[text width=2cm, align=center] at (38*\xsep,\y+\longtext/2){$\dot{M}/2$ [rev/day]};
  \node[text width=2cm, align=center] at (48*\xsep,\y+\longtext/2){$\ddot{M}/6$ [rev/day$^2$]};
  ...
  \node[text width=3.2cm, align=center] at (57.5*\xsep,-\eps-\longtext/2){Mean motion\\$n$ [rev/deg]};
