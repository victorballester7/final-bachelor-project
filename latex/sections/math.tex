...
\begin{proposition}[Rodrigues' formula]
  ...
  \begin{equation}
    P_n(x)=\frac{1}{2^n n!}\dv[n]{}{x}{\left(x^2-1\right)}^n
  \end{equation}
\end{proposition}
...
\begin{definition}
  Let $n\in\NN\cup\{0\}$ and $m\in\{-n,-(n-1),\ldots,0,\dots,n-1,n\}$. We define the \emph{spherical harmonic} $Y_n^m$ as the following function:
  \begin{equation}
...
\begin{equation}
  \int_0^{2\pi}\int_0^\pi Y_{n_1}^{m_1}(\theta,\phi) \overline{Y_{n_2}^{m_2}(\theta,\phi)} \dd{\phi}\dd{\theta}=\frac{2}{2n_1+1}\frac{(n_1+m_1)!}{(n_1-m_1)!} \delta_{n_1,n_2}\delta_{m_1,m_2}
\end{equation}
